...
declare module T4TS {
    /** Generated from T4TS.Example.Models.EntityObject`1[[T4TS.Example.Models.Device **/
    export interface EntityObject {
    }
    /** Generated from T4TS.Example.Models.EntityObjectId`1[[T4TS.Example.Models.Device **/
